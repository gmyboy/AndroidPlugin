...
/**
 * 网络请求工具类
 * Created by gmy on 19-10-23 17:58.
...
class HttpURLConnectionUtil {
    ...
    HttpURLConnectionUtil(String url, String httpMethod) throws Exception {
     ...
     * @param value
     */
    void addTextParameter(String name, String value) {
     ...
     * @param value
     */
    void addFileParameter(String name, File value) {
     ...
     * @return
     */
    String readBufferFromStream(InputStream input) {
        if (input == null)
            return null
